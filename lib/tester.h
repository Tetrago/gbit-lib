...
#include "common.h"
	...
	/*
	 * Runs the tester, which will run all enabled instruction from
	 * instructions.h and compare the output to a reference CPU. Returns a
	 * non-zero value if one or more instructions did not test successfully, and
	 * zero on success.
	 */
